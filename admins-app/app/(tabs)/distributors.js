    ...
    const handleOpenModal = (mode, distributor = null) => {
        ...
        if (mode === 'edit' && distributor) {
            ...
            setFormData({
                ...
                balance: distributor.balance ? distributor.balance.toString() : '',
            });
        } else {
            setFormData({
                name: '',
                                ...
                                >
                                    ...
                                    <View style={{ marginBottom: 12 }}>
                                        ...
                                        >
                                            ...
                                            >
                                                SN: {distributor.serialNumber || 'N/A'}
                                            </Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12 }}>
                                        <View style={{ flex: 1 }}>
                                            ...
                                            <Text className="text-sm font-semibold text-gray-900 mb-2">
                                                Balance: ₹{distributor.balance?.toLocaleString('en-IN') || '0'}
                                            </Text>
                                            <View
                                                style={{
                                                    alignSelf: 'flex-start',
                                                    ...
                                                    borderRadius: 20,
                                                    borderWidth: 1,
                                                    backgroundColor: distributor.status === 'Active' ? '#dcfce7' : '#fee2e2',
                                                    borderColor: distributor.status === 'Active' ? '#bbf7d0' : '#fecaca',
                                                }}
                                            >
                                                <Text
                                                    style={{
                                                        fontSize: 12,
                                                        fontWeight: '600',
                                                        color: distributor.status === 'Active' ? '#166534' : '#991b1b',
                                                    }}
                                                >
                                                    {distributor.status}
                                                </Text>
                                        ...
                                        <View style={{ flexDirection: 'row' }}>
                                            <TouchableOpacity
                                                onPress={() => handleOpenModal('edit', distributor)}
                    ...
                    <View className="bg-white rounded-2xl w-full max-w-md">
                        <View style={{ paddingHorizontal: 24, paddingVertical: 24 }}>
                            ...
                            <Text className="text-gray-600 text-center mb-6">
                                ...
                                <Text className="font-semibold">{selectedDistributor?.name}</Text>
